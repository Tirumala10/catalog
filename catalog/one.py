...
app.config['MAIL_USERNAME']='tirumalabanavathu10@gmail.com'
app.config['MAIL_PASSWORD']='tirupraba'
...
def verify_email():
	...
	msg=Message('One time password',sender='tirumalabanavathu10@gmailsss.com',recipients=[email])
	msg.body=str(otp)
	mail.send(msg)
